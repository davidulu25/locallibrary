    ...
    def setUpTestData(cls):
        ...
        for author_id in range(number_of_authors):
            Author.objects.create(
                ...
                last_name=f'SurnameSamuels {author_id}',
            )
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_book.genre.set(genre_objects_for_book) # Direct alignment of many-to-many types not allowed.
        test_book.save()
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'catalog/book_renew_librarian')
    
    # added test method below checks that the initial date of the form is three weeks into the future.
...
class AuthorCreateTestView(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_initial_date = datetime.date.today()
